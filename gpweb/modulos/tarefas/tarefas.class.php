...
'meuProj' => ($config['genero_projeto']=='o' ? 'Meus ' :'Minhas ').$config['projetos'], 
'minhaCia' => 'Tod'.$config['genero_tarefa'].'s '.$config['tarefas'].' para minh'.$config['genero_organizacao'].' '.$config['organizacao'], 
'semDesignado' => 'Tod'.$config['genero_tarefa'].'s '.ucfirst($config['tarefas']).' sem '.$config['usuario'].' designado', 
'tarefaCriada' => 'Tod'.$config['genero_tarefa'].'s '.$config['tarefas'].' que eu criei', 
'todos' => 'Tod'.$config['genero_tarefa'].'s '.$config['tarefas'], 
'todasterminadas7dias' => 'Tod'.$config['genero_tarefa'].'s '.$config['tarefas'].' terminad'.$config['genero_tarefa'].'s nos últimos 7 dias', 
'minhasterminadas7dias' => ($config['genero_tarefa']=='o' ? 'Meus ' :'Minhas ').$config['tarefas'].' terminad'.$config['genero_tarefa'].'s nos últimos 7 dias');
