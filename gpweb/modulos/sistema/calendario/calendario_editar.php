...
echo '<tr><td align="right" width="125">'.dica('Nome da '.'Agenda Coletiva'.'', 'Toda agenda coletiva necessita ter um nome para identificação.').'Nome:'.dicaF().'</td><td><input type="text" name="calendario_nome" value="'.$obj->calendario_nome.'" style="width:284px;" class="texto" /> *</td></tr>';
