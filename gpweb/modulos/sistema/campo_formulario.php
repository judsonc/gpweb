...
if ($Aplic->profissional) {
	...
	$tipos['painel_composicao']='Composição de painéis de indicadores';
	$tipos['painel_odometro']='Odômetro';
	if ($Aplic->modulo_ativo('swot') && $Aplic->checarModulo('swot', 'editar')) $tipos['mswot']='Matriz SWOT';
	}
