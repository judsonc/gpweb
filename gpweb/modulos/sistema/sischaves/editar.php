...
echo '</table></td>';
echo '<td id="adicionar_campo" style="display:"><a href="javascript: void(0);" onclick="incluir_campo();">'.imagem('icones/adicionar_g.png','Incluir Integrante','Clique neste ícone '.imagem('icones/adicionar.png').' para incluir um contato como campo n'.$config['genero_projeto'].' '.$config['projeto'].'.').'</a></td>';
