...
if($Aplic->profissional && $Aplic->usuario_super_admin) echo '<tr><td align="left">'.dica('Parecer', 'Abre interface para criação de textos de pareceres quando da assinatura de objeto do sistema.').'<a href="javascript:void(0);" onclick="url_passar(0, \'m=sistema&u=assinatura&a=assinatura_atesta\');">Parecer</a>'.dicaF().'</td></tr>';	
...
if ($Aplic->profissional && $Aplic->usuario_super_admin){
	echo '<tr><td width="42" valign="top">'.imagem('moeda.png','','',1).'</td><td><table><tr><td align="left" style="color:#666;margin-bottom:0;	margin-top:15px; font:700 12px verdana, arial, helvetica, sans-serif">Moedas</td></tr>';
	echo '<tr><td align="left">'.dica('Moedas Estrangeiras', 'Criar ou editar moedas estrangeiras e seus respectivos câmbios.').'<a href="javascript:void(0);" onclick="url_passar(0, \'m=sistema&u=moeda&a=moeda_lista\');">Configurar moedas estrangeiras</a>'.dicaF().'</td></tr>';
	echo '</table></td></tr>';
	}
