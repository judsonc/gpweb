...
if (!$dialogo && !$Aplic->profissional){
	...
	$botoesTitulo->adicionaBotao('m=arquivos&a=pasta_lista', 'lista de pastas','','Lista de Pastas','Visualizar a lista de pastas armazenadas.');
	if ($editar) $botoesTitulo->adicionaBotao('m=arquivos&a=editar_pasta&arquivo_pasta_id='.$arquivo_pasta_id, 'editar pasta','','Editar Pasta','Editar esta pasta.');
...
if ($Aplic->profissional){
	...
	if (count($lista)){	
		...
		foreach($lista as $gestao_data){	
			...
			elseif ($gestao_data['arquivo_pasta_gestao_mswot']) echo ($qnt++ ? '<br>' : '').imagem('../../../modulos/swot/imagens/mswot_p.png').link_mswot($gestao_data['arquivo_pasta_gestao_mswot']);
			...
			elseif ($gestao_data['arquivo_pasta_gestao_template']) echo ($qnt++ ? '<br>' : '').imagem('icones/template_p.gif').link_template($gestao_data['arquivo_pasta_gestao_template']);
