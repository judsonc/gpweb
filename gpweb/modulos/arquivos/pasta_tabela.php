		...
		if ($Aplic->profissional){
			...
			if (count($lista)){	
				foreach($lista as $gestao_data){	
					...
					elseif (isset($gestao_data['arquivo_pasta_gestao_mswot']) && $gestao_data['arquivo_pasta_gestao_mswot']) echo ($qnt_gestao++ ? '<br>' : '').imagem('../../../modulos/swot/imagens/mswot_p.png').link_mswot($gestao_data['arquivo_pasta_gestao_mswot']);
