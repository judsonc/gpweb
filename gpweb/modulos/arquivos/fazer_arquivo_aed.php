...
if ($duplicar) {
	...
	elseif($Aplic->profissional){
		...
		elseif ($linha['arquivo_gestao_objetivo'] && $qnt==1) $endereco='m=praticas&a=obj_estrategico_ver&objetivo_id='.$linha['arquivo_gestao_objetivo'];
		elseif ($linha['arquivo_gestao_fator'] && $qnt==1) $endereco='m=praticas&a=fator_ver&fator_id='.$linha['arquivo_gestao_fator'];
		...
		elseif ($linha['arquivo_gestao_mswot'] && $qnt==1) $endereco='m=swot&a=mswot_ver&mswot_id='.$linha['arquivo_gestao_mswot'];
		...
		elseif ($linha['arquivo_gestao_instrumento'] && $qnt==1) $endereco='m=instrumento&a=instrumento_ver&instrumento_id='.$linha['arquivo_gestao_instrumento'];
	...
	elseif ($obj->arquivo_instrumento) $Aplic->redirecionar('m=instrumento&a=instrumento_ver&tab=0&instrumento_id='.$obj->arquivo_instrumento); 
	...
	elseif ($obj->arquivo_objetivo) $Aplic->redirecionar('m=praticas&a=obj_estrategico_ver&tab=3&objetivo_id='.$obj->arquivo_objetivo);
	elseif ($obj->arquivo_fator) $Aplic->redirecionar('m=praticas&a=fator_ver&tab=3&fator_id='.$obj->arquivo_fator);
...
if (!$Aplic->profissional && $arquivo_id && (($obj->arquivo_projeto != $antigoObj->arquivo_projeto) || ($obj->arquivo_indicador != $antigoObj->arquivo_indicador) || ($obj->arquivo_pratica != $antigoObj->arquivo_pratica) || ($obj->arquivo_demanda != $antigoObj->arquivo_demanda) || ($obj->arquivo_instrumento != $antigoObj->arquivo_instrumento)|| ($obj->arquivo_usuario != $antigoObj->arquivo_usuario) || ($obj->arquivo_tema != $antigoObj->arquivo_tema) || ($obj->arquivo_objetivo != $antigoObj->arquivo_objetivo)  || ($obj->arquivo_estrategia != $antigoObj->arquivo_estrategia) || ($obj->arquivo_acao != $antigoObj->arquivo_acao) || ($obj->arquivo_fator != $antigoObj->arquivo_fator) || ($obj->arquivo_meta != $antigoObj->arquivo_meta) || ($obj->arquivo_perspectiva != $antigoObj->arquivo_perspectiva) || ($obj->arquivo_canvas != $antigoObj->arquivo_canvas) || ($obj->arquivo_calendario != $antigoObj->arquivo_calendario) || ($obj->arquivo_ata != $antigoObj->arquivo_ata))) {
	...
	if (!$res) {
		...
		$Aplic->redirecionar('m=arquivos&projeto_id='.$obj->arquivo_projeto.'&pratica_indicador_id='.$obj->arquivo_indicador.'&pratica_id='.$obj->arquivo_pratica.'&demanda_id='.$obj->arquivo_demanda.'&instrumento_id='.$obj->arquivo_instrumento.'&arquivo_usuario='.$obj->arquivo_usuario.'&tema_id='.$obj->arquivo_tema.'&objetivo_id='.$obj->arquivo_objetivo.'&pg_estrategia_id='.$obj->arquivo_estrategia.'&plano_acao_id='.$obj->arquivo_acao.'&fator_id='.$obj->arquivo_fator.'&pg_meta_id='.$obj->arquivo_meta.'&pg_perspectiva_id='.$obj->arquivo_perspectiva.'&canvas_id='.$obj->arquivo_canvas.'&calendario_id='.$obj->arquivo_calendario.'&ata_id='.$obj->arquivo_ata);
		}
	}
