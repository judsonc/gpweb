...
'completado_titulo'=>ucfirst($config['tarefas']).' concluíd'.$config['genero_tarefa'].'s',
'completado_descricao'=>ucfirst($config['tarefas']).' concluíd'.$config['genero_tarefa'].'s na última semana',
