...
function atualizar_gestao($instrumento_id=0, $uuid=''){
  ...
  $saida='';
	...
	foreach($lista as $gestao_data){
		...
		elseif ($gestao_data['instrumento_gestao_mswot']) $saida.= '<td align=left>'.imagem('../../../modulos/swot/imagens/mswot_p.png').link_mswot($gestao_data['instrumento_gestao_mswot']).'</td>';
