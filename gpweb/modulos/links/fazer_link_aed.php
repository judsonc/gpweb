...
if ($del) {
	...
	elseif ($obj->link_objetivo) $Aplic->redirecionar('m=praticas&a=obj_estrategico_ver&tab=3&objetivo_id='.$obj->link_objetivo);
	elseif ($obj->link_fator) $Aplic->redirecionar('m=praticas&a=fator_ver&tab=3&fator_id='.$obj->link_fator);
...
if ($Aplic->profissional && getParam($_REQUEST, 'uuid', null)){
	...
	elseif ($linha['link_gestao_objetivo'] && $qnt==1) $endereco='m=praticas&a=obj_estrategico_ver&objetivo_id='.$linha['link_gestao_objetivo'];
	elseif ($linha['link_gestao_fator'] && $qnt==1) $endereco='m=praticas&a=fator_ver&fator_id='.$linha['link_gestao_fator'];
	...
	elseif ($linha['link_gestao_mswot'] && $qnt==1) $endereco='m=swot&a=mswot_ver&mswot_id='.$linha['link_gestao_mswot'];
	...
	elseif ($linha['link_gestao_instrumento'] && $qnt==1) $endereco='m=instrumento&a=instrumento_ver&instrumento_id='.$linha['link_gestao_instrumento'];
