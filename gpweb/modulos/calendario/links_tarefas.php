...
function getProblemaLinks($periodo_todo=false, $inicioPeriodo, $fimPeriodo, $links, $strMaxLarg, $minutoiCal = false, $usuario_id=null, $cia_id = null, $dept_id=null, 
	...
	elseif ($objetivo_id) $sql->adOnde('problema_gestao_objetivo='.(int)$objetivo_id);
	elseif ($fator_id) $sql->adOnde('problema_gestao_fator='.(int)$fator_id);
	...
	elseif ($mswot_id) $sql->adOnde('problema_gestao_mswot='.(int)$mswot_id);
...
function getAtaLinks($periodo_todo=false, $inicioPeriodo, $fimPeriodo, $links, $strMaxLarg, $minutoiCal = false, $usuario_id=null, $cia_id = null, $dept_id=null, 
	...
	elseif ($objetivo_id) $sql->adOnde('ata_gestao_objetivo='.(int)$objetivo_id);
	elseif ($fator_id) $sql->adOnde('ata_gestao_fator='.(int)$fator_id);
	...
	elseif ($mswot_id) $sql->adOnde('ata_gestao_mswot='.(int)$mswot_id);
