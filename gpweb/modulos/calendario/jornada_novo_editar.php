...
if ($jornada_id) $obj->load($jornada_id);
else {
	$diasUteis=explode (',', $config['cal_dias_uteis']);
	if (in_array(0, $diasUteis)){	
		$obj->jornada_1_inicio=$config['expediente_inicio'];
		$obj->jornada_1_almoco_inicio=$config['almoco_inicio'];
		$obj->jornada_1_almoco_fim=$config['almoco_fim'];
		$obj->jornada_1_fim=$config['expediente_fim'];
		}
	if (in_array(1, $diasUteis)){
		$obj->jornada_2_inicio=$config['expediente_inicio'];
		$obj->jornada_2_almoco_inicio=$config['almoco_inicio'];
		$obj->jornada_2_almoco_fim=$config['almoco_fim'];
		$obj->jornada_2_fim=$config['expediente_fim'];
		}
	if (in_array(2, $diasUteis)){
		$obj->jornada_3_inicio=$config['expediente_inicio'];
		$obj->jornada_3_almoco_inicio=$config['almoco_inicio'];
		$obj->jornada_3_almoco_fim=$config['almoco_fim'];
		$obj->jornada_3_fim=$config['expediente_fim'];
		}
	if (in_array(3, $diasUteis)){
		$obj->jornada_4_inicio=$config['expediente_inicio'];
		$obj->jornada_4_almoco_inicio=$config['almoco_inicio'];
		$obj->jornada_4_almoco_fim=$config['almoco_fim'];
		$obj->jornada_4_fim=$config['expediente_fim'];
		}
	if (in_array(4, $diasUteis)){
		$obj->jornada_5_inicio=$config['expediente_inicio'];
		$obj->jornada_5_almoco_inicio=$config['almoco_inicio'];
		$obj->jornada_5_almoco_fim=$config['almoco_fim'];
		$obj->jornada_5_fim=$config['expediente_fim'];
		}
	if (in_array(5, $diasUteis)){
		$obj->jornada_6_inicio=$config['expediente_inicio'];
		$obj->jornada_6_almoco_inicio=$config['almoco_inicio'];
		$obj->jornada_6_almoco_fim=$config['almoco_fim'];
		$obj->jornada_6_fim=$config['expediente_fim'];
		}
	if (in_array(6, $diasUteis)){
		$obj->jornada_7_inicio=$config['expediente_inicio'];
		$obj->jornada_7_almoco_inicio=$config['almoco_inicio'];
		$obj->jornada_7_almoco_fim=$config['almoco_fim'];
		$obj->jornada_7_fim=$config['expediente_fim'];
		}
	}
