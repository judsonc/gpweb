...
$plano_acao_id = $Aplic->getEstado('plano_acao_id', 0);
...
if (!$dialogo){
	...
	elseif($swot_id){
		$legenda_filtro=dica('Filtrar pelo Campo SWOT', 'Filtrar os eventos pela matriz SWOT relacionado.').'Campo SWOT:'.dicaF();
...
if (!$dialogo&& $Aplic->profissional){
	$botoesTitulo = new CBlocoTitulo('Calendário Anual', 'calendario.png', $m, $m.'.'.$a);
  ...
  $saida.='<table cellspacing=0 cellpadding=0>';
	...
	$imprimir='<tr><td nowrap="nowrap">'.dica('Imprimir o Ano', 'Clique neste ícone '.imagem('imprimir_p.png').' para abrir uma nova janela onde poderá imprimir o ano a partir do navegador Web.').'<a href="javascript: void(0);" onclick ="url_passar(1,\'m=calendario&a=ver_ano&dialogo=1&data='.$data.'\');">'.imagem('imprimir_p.png').'</a>'.dicaF().'</td></tr>';
...
elseif (!$dialogo&& !$Aplic->profissional){
	...
	$botoesTitulo->adicionaCelula(dica('Imprimir o Ano', 'Clique neste ícone '.imagem('imprimir_p.png').' para abrir uma nova janela onde poderá imprimir o ano a partir do navegador Web.').'<a href="javascript: void(0);" onclick ="url_passar(1,\'m=calendario&a=ver_ano&dialogo=1&data='.$data.'\');">'.imagem('imprimir_p.png').'</a>'.dicaF());
	$botoesTitulo->mostrar();
	}
...
echo '<table border=0 cellspacing=0 cellpadding=0 width="100%" class="motitulo">';
echo '<tr><td><a href="javascript:void(0);" onclick="url_passar(0, \'m=calendario&a=ver_ano&data='.$anoAnterior.'\');">'.imagem('icones/'.($estilo_interface=='metro' ? 'navAnterior_metro.png' :'anterior.gif'), 'Ano Anterior', 'Clique neste ícone '.imagem('icones/'.($estilo_interface=='metro' ? 'navAnterior_metro.png' :'anterior.gif')).' para exibir o ano anterior.').'</a></td>';
echo '<td width="100%" align="center"><b>'.htmlentities($data->format('%Y')).'</b></td><td><a href="javascript:void(0);" onclick="url_passar(0, \'m=calendario&a=ver_ano&data='.$anoProximo.'\');">'.imagem('icones/'.($estilo_interface=='metro' ? 'navProximo_metro.png' :'proximo.gif'), 'Próximo Ano', 'Clique neste ícone '.imagem('icones/'.($estilo_interface=='metro' ? 'navProximo_metro.png' :'proximo.gif')).' para exibir o próximo ano.').'</a></td></tr></table></td></tr>';
$minutoiCal = new CCalendarioMes($data);
...
echo '<tr><td><table class="minical" align=center>';
echo '<tr>';
echo '<td style="border-style:solid;border-width:1px" class="evento">&nbsp;&nbsp;</td><td nowrap="nowrap">evento</td><td>&nbsp;</td>';
echo '<td style="border-style:solid;border-width:1px" class="acao">&nbsp;&nbsp;</td><td nowrap="nowrap">ação</td><td>&nbsp;</td>';
echo '<td style="border-style:solid;border-width:1px" class="tarefa">&nbsp;&nbsp;</td><td nowrap="nowrap">'.$config['tarefa'].'</td><td>&nbsp;</td>';
if ($ata_ativo) echo '<td style="border-style:solid;border-width:1px" class="ata">&nbsp;&nbsp;</td><td nowrap="nowrap">ata de reunião</td><td>&nbsp;</td>';
if ($problema_ativo) echo '<td style="border-style:solid;border-width:1px" class="problema">&nbsp;&nbsp;</td><td nowrap="nowrap">'.$config['problema'].'</td><td>&nbsp;</td>';
echo '<td style="border-style:solid;border-width:1px" class="multiplo">&nbsp;&nbsp;</td><td nowrap="nowrap">múltiplos</td><td>&nbsp;</td>';
echo '</tr>';
echo '<tr>';
...
function clicarDia( uts, dataFim ) {
	url_passar(0, 'm=calendario&a=ver_dia&data='+uts);
	}
