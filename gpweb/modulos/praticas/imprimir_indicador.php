...
echo '<table width="100%" cellpadding=0 cellspacing="18">';
echo '<tr><td align="center"><h1>'.$pratica_indicador['pratica_indicador_nome'].'</h1></td></tr><tr><td>';
...
if (!$Aplic->profissional && isset($config['barra_projeto']) && $config['barra_projeto']){
