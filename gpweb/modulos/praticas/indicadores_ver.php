...
if ($Aplic->profissional){
	...
	elseif ($objetivo_id) $sql->adOnde('pratica_indicador_gestao_objetivo='.(int)$objetivo_id);
	elseif ($fator_id) $sql->adOnde('pratica_indicador_gestao_fator='.(int)$fator_id);
	...
	elseif ($mswot_id) $sql->adOnde('pratica_indicador_gestao_mswot='.(int)$mswot_id);
	...
	elseif ($objetivo_id) $sql->adOnde('pratica_indicador_objetivo_estrategico = '.(int)$objetivo_id);
	elseif ($fator_id) $sql->adOnde('pratica_indicador_fator = '.(int)$fator_id);
