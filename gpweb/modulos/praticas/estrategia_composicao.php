...
echo '<tr><td align="left"><table cellspacing=0 cellpadding=0><tr><td>'.botao('adicionar', 'Adicionar', 'Utilize este botão para adicionar um '.$config['iniciativa'].' à lista das selecionadas</p>Caso deseje inserir multiplas iniciativas de uma única vez, mantenha o botão <i>CTRL</i> pressionado enquanto clica com o botão esquerdo do mouse nas iniciativas da lista acima.','','Mover()','','',0).'</td></tr></table></td><td>&nbsp;</td><td align="right">'.botao('remover', 'Remover', 'Utilize este botão para retirar um '.$config['iniciativa'].' da lista das selecionadas. </p>Caso deseje remover multiplas iniciativas estratégicas de uma única vez, mantenha o botão <i>CTRL</i> pressionado enquanto clica com o botão esquerdo do mouse nas iniciativas da lista acima.','','Remover()','','',0).'</td></tr>';
