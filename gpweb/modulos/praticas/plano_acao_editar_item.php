...
echo '<tr><td align="right">'.dica('Nome do item d'.$config['genero_acao'].' '.ucfirst($config['acao']), 'Todo item d'.$config['genero_acao'].' '.$config['acao'].' necessita ter um nome para identificação.').'Nome:'.dicaF().'</td><td><input type="text" id="plano_acao_item_nome" name="plano_acao_item_nome" value="" style="width:234px;" class="texto" />*</td></tr>';
...
echo '<tr>';
echo '<td id="adicionar_acao" style="display:"><a href="javascript: void(0);" onclick="incluir_acao();">'.imagem('icones/adicionar_g.png','Incluir','Clique neste ícone '.imagem('icones/adicionar.png').' para incluir a ação.').'</a></td>';
echo '<td id="confirmar_acao" style="display:none"><a href="javascript: void(0);" onclick="limpar();	document.getElementById(\'confirmar_acao\').style.display=\'none\';">'.imagem('icones/cancelar_g.png','Cancelar','Clique neste ícone '.imagem('icones/cancelar.png').' para cancelar a edição da ação.').'</a><a href="javascript: void(0);" onclick="incluir_acao();">'.imagem('icones/ok_g.png','Confirmar','Clique neste ícone '.imagem('icones/ok.png').' para confirmar a edição da ação.').'</a></td>';
