...
if (!$dialogo && $Aplic->profissional){
  ...
  $saida.='<table cellspacing=0 cellpadding=0>';
	...
	$imprimir='<tr><td nowrap="nowrap" align="right"><a href="javascript: void(0);" onclick ="url_passar(1, \'m='.$m.'&a='.$a.'&u='.$u.'&dialogo=1\');">'.imagem('imprimir_p.png', 'Imprimir', 'Clique neste ícone '.imagem('imprimir_p.png').' para imprimir a lista.').'</a></td></tr>';

	$saida.='<tr><td><table cellspacing=0 cellpadding=0>'.$procurar_om.$procurar_usuario.'</table></td><td><table cellspacing=0 cellpadding=0>'.$novo.$imprimir.'</table></td></tr></table>';
	$saida.= '</div></div>';
...
elseif ($Aplic->profissional){
	...
	echo '</td></tr></table>';
	echo 	'<font size="4"><center>Planejamentos Estratégicos</center></font>';
	}
echo '</form>';
