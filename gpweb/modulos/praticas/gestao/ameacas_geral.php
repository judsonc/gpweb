...
echo '<tr><td colspan=2 align="left"><h1>Ambiente Externo - Ameaças</h1></td></tr>';
if ($editarPG || $pg['pg_ameaca']) echo '<tr><td colspan=2 align="left"><b>Informações gerais sobre as ameaças para '.$config['genero_organizacao'].' '.$config['organizacao'].'</b></td></tr>';
