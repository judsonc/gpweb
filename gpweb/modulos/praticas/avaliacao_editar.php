...
echo '<tr><td align="right">'.dica('Nome da Avaliação', 'Toda avaliação necessita ter um nome para identificação.').'Nome:'.dicaF().'</td><td><input type="text" name="avaliacao_nome" value="'.$obj->avaliacao_nome.'" style="width:284px;" class="texto" /> *</td></tr>';
