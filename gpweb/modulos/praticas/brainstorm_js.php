...
function popProjeto_filtro() {
	if (window.parent.gpwebApp) parent.gpwebApp.popUp('<?php echo ucfirst($config["projeto"])?>', 600, 500, 'm=publico&a=selecionar&dialogo=1&chamar_volta=setProjeto_filtro&aceita_portfolio=1&tabela=projetos&cia_id='+document.getElementById('cia_id').value, window.setProjeto_filtro, window);
