...
if (isset($_REQUEST['plano_acao_duracao'])) $_REQUEST['plano_acao_duracao']=getParam($_REQUEST, 'plano_acao_duracao', null)*$config['horas_trab_diario'];
$obj = new CPlanoAcao();
...
if ($Aplic->profissional && $uuid){
	...
	elseif ($linha['plano_acao_gestao_objetivo'] && $qnt==1) $endereco='m=praticas&a=obj_estrategico_ver&objetivo_id='.$linha['plano_acao_gestao_objetivo'];
	elseif ($linha['plano_acao_gestao_fator'] && $qnt==1) $endereco='m=praticas&a=fator_ver&fator_id='.$linha['plano_acao_gestao_fator'];
	...
	elseif ($linha['plano_acao_gestao_mswot'] && $qnt==1) $endereco='m=swot&a=mswot_ver&mswot_id='.$linha['plano_acao_gestao_mswot'];
	...
	elseif ($linha['plano_acao_gestao_instrumento'] && $qnt==1) $endereco='m=instrumento&a=instrumento_ver&instrumento_id='.$linha['plano_acao_gestao_instrumento'];
...
elseif ($obj->plano_acao_objetivo) $Aplic->redirecionar('m=praticas&a=obj_estrategico_ver&tab=3&objetivo_id='.$obj->plano_acao_objetivo);
elseif ($obj->plano_acao_fator) $Aplic->redirecionar('m=praticas&a=fator_ver&tab=3&fator_id='.$obj->plano_acao_fator);
