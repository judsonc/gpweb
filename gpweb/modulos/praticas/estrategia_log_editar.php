...
echo '<tr><td align="right">'.dica('Valor Gasto', 'Valor gasto n'.$config['genero_objetivo'].' '.$config['objetivo'].'.').'Valor Gasto:'.dicaF().'</td><td><input type="text" style="text-align:right;" class="texto" onkeypress="return entradaNumerica(event, this, true, true);" name="pg_estrategia_log_custo" value="'.($log->pg_estrategia_log_custo ? number_format($log->pg_estrategia_log_custo, 2, ',', '.') : '').'" size="40" /></td></tr>';  
