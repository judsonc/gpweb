...
if(!($podeEditar&& permiteEditarChecklist($obj->checklist_acesso,$checklist_id))) $Aplic->redirecionar('m=publico&a=acesso_negado');
...
if ($obj->checklist_cia) $cia_id=$obj->checklist_cia;
...
echo '<tr><td align="right">'.dica('Nome do Checklist', 'Todo checklist necessita ter um nome para identificação.').'Nome:'.dicaF().'</td><td><input type="text" name="checklist_nome" value="'.($obj->checklist_nome ? $obj->checklist_nome : '').'" style="width:284px;" class="texto" /> *</td></tr>';
...
echo '<tr><td align="right" nowrap="nowrap" width="100">'.dica('Responsável', 'Toda meta deve ter um responsável.').'Responsável:'.dicaF().'</td><td colspan="2"><input type="hidden" id="checklist_responsavel" name="checklist_responsavel" value="'.($obj->checklist_responsavel ? $obj->checklist_responsavel : $Aplic->usuario_id).'" /><input type="text" id="nome_gerente" name="nome_gerente" value="'.nome_om(($obj->checklist_responsavel ? $obj->checklist_responsavel : $Aplic->usuario_id),$Aplic->getPref('om_usuario')).'" style="width:284px;" class="texto" READONLY /><a href="javascript: void(0);" onclick="popGerente();">'.imagem('icones/usuarios.gif','Selecionar '.ucfirst($config['usuario']),'Clique neste ícone '.imagem('icones/usuarios.gif').' para selecionar '.($config['genero_usuario']=='o' ? 'um' : 'uma').' '.$config['usuario'].'.').'</a></td></tr>';
...
echo '<tr><td align="right">'.dica('Descrição', 'Uma breve descrição do checklist, caso seja pertinente.').'Descrição</td><td><textarea data-gpweb-cmp="ckeditor" rows="10" name="checklist_descricao" id="checklist_descricao">'.$obj->checklist_descricao.'</textarea></td></tr>';
...
echo '<tr><td align="right" nowrap="nowrap">'.dica('Modelo', 'Escolha o modelo de checklist.').'Modelo:'.dicaF().'</td><td width="100%" colspan="2">'.selecionaVetor($modelos, 'checklist_modelo', 'class="texto" style="width:284px;"', ($obj->checklist_modelo ? $obj->checklist_modelo : '1')).'</td></tr>';

echo '<tr><td align="right" nowrap="nowrap">'.dica('Checklist Superior', 'Caso este check list tenha um cheklist superior selecione o mesmo.').'Checklist superior:'.dicaF().'</td><td width="100%" colspan="2"><table cellspacing=0 cellpadding=0><tr><td><input type="hidden" id="checklist_superior" name="checklist_superior" value="'.($obj->checklist_superior ? $obj->checklist_superior : null).'" /><input type="text" id="nome_checklist" name="nome_checklist" value="'.nome_checklist(($obj->checklist_superior ? $obj->checklist_superior : null)).'" style="width:284px;" class="texto" READONLY /><a href="javascript: void(0);" onclick="popChecklist();">'.imagem('icones/todo_list_p.png','Selecionar Checklist','Clique neste ícone '.imagem('icones/todo_list_p.png').' para selecionar um checklist.').'</a></td></tr></table></td></tr>';
...
if ($Aplic->profissional){
	...
	if ($swot_ativo) {
		echo '<tr '.(isset($checklist_mswot) && $checklist_mswot ? '' : 'style="display:none"').' id="mswot" ><td align="right" nowrap="nowrap">'.dica('Matriz SWOT', 'Caso o checklist seja específico de uma matriz SWOT neste campo deverá constar o nome da matriz SWOT').'Matriz SWOT:'.dicaF().'</td><td><table cellspacing=0 cellpadding=0><tr><td><input type="hidden" name="checklist_mswot" value="'.(isset($checklist_mswot) ? $checklist_mswot : '').'" /><input type="text" id="mswot_nome" name="mswot_nome" value="'.nome_mswot((isset($checklist_mswot) ? $checklist_mswot : null)).'" style="width:250px;" class="texto" READONLY /></td><td><a href="javascript: void(0);" onclick="popMSWOT();">'.imagem('../../../modulos/swot/imagens/mswot_p.png','Selecionar Matriz SWOT','Clique neste ícone '.imagem('../../../modulos/swot/imagens/mswot_p.png').' para selecionar uma matriz SWOT.').'</a></td></tr></table></td></tr>';
		echo '<tr '.(isset($checklist_swot) && $checklist_swot ? '' : 'style="display:none"').' id="swot" ><td align="right" nowrap="nowrap">'.dica('Campo SWOT', 'Caso o checklist seja específico de um campo de matriz SWOT neste campo deverá constar o nome do campo de matriz SWOT').'Campo SWOT:'.dicaF().'</td><td><table cellspacing=0 cellpadding=0><tr><td><input type="hidden" name="checklist_swot" value="'.(isset($checklist_swot) ? $checklist_swot : '').'" /><input type="text" id="swot_nome" name="swot_nome" value="'.nome_swot((isset($checklist_swot) ? $checklist_swot : null)).'" style="width:250px;" class="texto" READONLY /></td><td><a href="javascript: void(0);" onclick="popSWOT();">'.imagem('../../../modulos/swot/imagens/swot_p.png','Selecionar Campo SWOT','Clique neste ícone '.imagem('../../../modulos/swot/imagens/swot_p.png').' para selecionar um campo de matriz SWOT.').'</a></td></tr></table></td></tr>';
		}
	else {
		echo '<input type="hidden" name="checklist_mswot" value="" id="mswot" /><input type="hidden" id="mswot_nome" name="mswot_nome" value="">';
		echo '<input type="hidden" name="checklist_swot" value="" id="swot" /><input type="hidden" id="swot_nome" name="swot_nome" value="">';
		}
  ...
  $sql->limpar();
	...
	foreach($lista as $gestao_data){
		...
		elseif ($gestao_data['checklist_gestao_mswot']) echo '<td align=left>'.imagem('../../../modulos/swot/imagens/mswot_p.png').link_mswot($gestao_data['checklist_gestao_mswot']).'</td>';
...
if ($Aplic->profissional){
	...
	$sql->limpar();
	if (count($indicadores)>1) echo '<tr><td align="right" nowrap="nowrap">'.dica('Indicador Principal', 'Escolha dentre os indicadores relacionados mais representativo da situação geral.').'Indicador principal:'.dicaF().'</td><td width="100%" colspan="2">'.selecionaVetor($indicadores, 'checklist_principal_indicador', 'class="texto" style="width:284px;"', $obj->checklist_principal_indicador).'</td></tr>';
...
if ($Aplic->profissional && $exibir['moeda']){
	...
	$sql->limpar();
	echo '<tr><td align="right" nowrap="nowrap">'.dica('Moeda', 'Escolha a moeda padrão utilizada.').'Moeda:'.dicaF().'</td><td>'.selecionaVetor($moedas, 'checklist_moeda', 'class=texto size=1', ($obj->checklist_moeda ? $obj->checklist_moeda : 1)).'</td></tr>';
	}	
...
echo '<tr><td align="right" width="100">'.dica('Ativo', 'Caso o checklist ainda esteja ativo deverá estar marcado este campo.').'Ativo:'.dicaF().'</td><td><input type="checkbox" value="1" name="checklist_ativo" '.($obj->checklist_ativo || !$checklist_id ? 'checked="checked"' : '').' /></td></tr>';
...
echo '<input type="hidden" id="texto_apoio" name="texto_apoio" value="" />';
	...
	echo '</table></td>
	<td id="adicionar_pergunta" style="display:"><a href="javascript: void(0);" onclick="incluir_pergunta();">'.imagem('icones/adicionar_g.png','Incluir','Clique neste ícone '.imagem('icones/adicionar.png').' para incluir a pergunta do checklist.').'</a></td>';
	echo '<td id="confirmar_pergunta" style="display:none"><a href="javascript: void(0);" onclick="document.getElementById(\'checklist_lista_id\').value=0;	document.getElementById(\'checklist_lista_peso\').value=\'1\'; document.getElementById(\'texto_apoio\').value=\'\'; CKEDITOR.instances[\'checklist_lista_descricao\'].setData(\'\'); document.getElementById(\'adicionar_pergunta\').style.display=\'\'; document.getElementById(\'checklist_lista_legenda\').checked=false; document.getElementById(\'confirmar_pergunta\').style.display=\'none\';">'.imagem('icones/cancelar_g.png','Cancelar','Clique neste ícone '.imagem('icones/cancelar.png').' para cancelar a edição da pergunta do checklist.').'</a><a href="javascript: void(0);" onclick="incluir_pergunta();">'.imagem('icones/ok_g.png','Confirmar','Clique neste ícone '.imagem('icones/ok.png').' para confirmar a edição da pergunta do checklist.').'</a></td></tr></table></td></tr>';
...
function popObjetivo() {
	if (window.parent.gpwebApp) parent.gpwebApp.popUp('<?php echo ucfirst($config["objetivo"])?>', 500, 500, 'm=publico&a=selecionar&dialogo=1&chamar_volta=setObjetivo&tabela=objetivo&cia_id='+document.getElementById('checklist_cia').value, window.setObjetivo, window);
	else window.open('./index.php?m=publico&a=selecionar&dialogo=1&chamar_volta=setObjetivo&tabela=objetivo&cia_id='+document.getElementById('checklist_cia').value, '<?php echo ucfirst($config["objetivo"])?>','left=0,top=0,height=600,width=600,scrollbars=yes, resizable=yes');
	}
...
function popFator() {
	if (window.parent.gpwebApp) parent.gpwebApp.popUp('<?php echo ucfirst($config["fator"])?>', 500, 500, 'm=publico&a=selecionar&dialogo=1&chamar_volta=setFator&tabela=fator&cia_id='+document.getElementById('checklist_cia').value, window.setFator, window);
	else window.open('./index.php?m=publico&a=selecionar&dialogo=1&chamar_volta=setFator&tabela=fator&cia_id='+document.getElementById('checklist_cia').value, '<?php echo ucfirst($config["fator"])?>','left=0,top=0,height=600,width=600,scrollbars=yes, resizable=yes');
	}
...
function popMSWOT() {
	parent.gpwebApp.popUp('Matriz SWOT', 500, 500, 'm=swot&a=selecionar&dialogo=1&chamar_volta=setMSWOT&tabela=mswot&cia_id='+document.getElementById('checklist_cia').value, window.setMSWOT, window);
	}
...
function popSWOT() {
	parent.gpwebApp.popUp('Campo SWOT', 500, 500, 'm=swot&a=selecionar&dialogo=1&chamar_volta=setSWOT&tabela=swot&cia_id='+document.getElementById('checklist_cia').value, window.setSWOT, window);
	}
...
function popArquivo() {
	if (window.parent.gpwebApp) parent.gpwebApp.popUp('Arquivo', 500, 500, 'm=publico&a=selecionar&dialogo=1&chamar_volta=setArquivo&tabela=arquivo&cia_id='+document.getElementById('checklist_cia').value, window.setArquivo, window);
	else window.open('./index.php?m=publico&a=selecionar&dialogo=1&chamar_volta=setArquivo&tabela=arquivo&cia_id='+document.getElementById('checklist_cia').value, 'Arquivo','left=0,top=0,height=600,width=600,scrollbars=yes, resizable=yes');
	}
...
function limpar_tudo(){
	...
	<?php
	if($swot_ativo) {
		echo 'document.env.mswot_nome.value = \'\';	document.env.checklist_mswot.value = null;';
		echo 'document.env.swot_nome.value = \'\';	document.env.checklist_swot.value = null;';
		}
