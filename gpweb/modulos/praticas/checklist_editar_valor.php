...
$pratica_indicador_valor_data=getParam($_REQUEST, 'pratica_indicador_valor_data', null);
...
$data = isset($pratica_indicado_valor['pratica_indicador_valor_data']) ? new CData($pratica_indicado_valor['pratica_indicador_valor_data']) : new CData($pratica_indicador_valor_data);
...
echo '<tr>';
echo '<td id="adicionar_acao" style="display:'.($checklist_dados_id ? 'none' : '').'"><a href="javascript: void(0);" onclick="enviarDados();">'.imagem('icones/adicionar_g.png','Incluir','Clique neste ícone '.imagem('icones/adicionar.png').' para incluir o checklist.').'</a></td>';
echo '<td id="confirmar_acao" style="display:'.($checklist_dados_id ? '' : 'none').'"><a href="javascript: void(0);" onclick="enviarDados();">'.imagem('icones/ok_g.png','Confirmar','Clique neste ícone '.imagem('icones/ok.png').' para confirmar a edição do checklist.').'</a><a href="javascript: void(0);" onclick="limpar(); document.getElementById(\'confirmar_acao\').style.display=\'none\';">'.imagem('icones/cancelar_g.png','Cancelar','Clique neste ícone '.imagem('icones/cancelar_g.png').' para cancelar a edição do checklist.').'</a></td>';
