...
echo '<tr><td align="right">'.dica('Nome da Lacuna de Indicador', 'Toda lacuna de indicador necessita ter um nome para identificação.').'Nome:'.dicaF().'</td><td><input type="text" name="indicador_lacuna_nome" value="'.$obj->indicador_lacuna_nome.'" size="50" maxlength="512" class="texto" /> *</td></tr>';
