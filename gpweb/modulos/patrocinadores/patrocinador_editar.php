...
echo '<tr><td align="right">'.dica('Nome do Patrocinador', 'Todo patrocinador necessita ter um nome para identificação.').'Nome:'.dicaF().'</td><td><input type="text" name="patrocinador_nome" value="'.$obj->patrocinador_nome.'" style="width:350px;" class="texto" /> *</td></tr>';
echo '<tr><td align="right" nowrap="nowrap">'.dica(ucfirst($config['organizacao']).' Responsável', 'A qual '.$config['organizacao'].' pertence este patrocinador.').ucfirst($config['organizacao']).' responsável:'.dicaF().'</td><td><div id="combo_cia">'.selecionar_om($cia_id, 'patrocinador_cia', 'class=texto size=1 style="width:350px;" onchange="javascript:mudar_om();"').'</div></td></tr>';
if ($Aplic->profissional) {
	$saida_cias='';
	...
	echo '<tr><td align="right" nowrap="nowrap">'.dica(ucfirst($config['organizacoes']).' Envolvid'.$config['genero_organizacao'].'s', 'Quais '.strtolower($config['organizacoes']).' estão envolvid'.$config['genero_organizacao'].'s.').ucfirst($config['organizacoes']).' envolvid'.$config['genero_organizacao'].'s:'.dicaF().'</td><td><table cellpadding=0 cellspacing=0><tr><td style="width:350px;"><div id="combo_cias">'.$saida_cias.'</div></td><td>'.botao_icone('organizacao_p.gif','Selecionar', 'selecionar '.$config['organizacoes'],'popCias()').'</td></tr></table></td></tr>';
	}
...
echo '<tr><td align="right" nowrap="nowrap">'.dica(ucfirst($config['departamentos']).' Envolvid'.$config['genero_dept'].'s', 'Quais '.strtolower($config['departamentos']).' estão envolvid'.$config['genero_dept'].'s.').ucfirst($config['departamentos']).' envolvid'.$config['genero_dept'].'s:'.dicaF().'</td><td><table cellpadding=0 cellspacing=0><tr><td style="width:350px;"><div id="combo_depts">'.$saida_depts.'</div></td><td>'.botao_icone('secoes_p.gif','Selecionar', 'selecionar '.$config['departamentos'],'popDepts()').'</td></tr></table></td></tr>';



echo '<tr><td align="right" nowrap="nowrap">'.dica('Responsável', 'Todo patrocinio deve ter um responsável.').'Responsável:'.dicaF().'</td><td colspan="2"><input type="hidden" id="patrocinador_responsavel" name="patrocinador_responsavel" value="'.($obj->patrocinador_responsavel ? $obj->patrocinador_responsavel : $Aplic->usuario_id).'" /><input type="text" id="nome_gerente" name="nome_gerente" value="'.nome_om(($obj->patrocinador_responsavel? $obj->patrocinador_responsavel : $Aplic->usuario_id),$Aplic->getPref('om_usuario')).'" style="width:350px;" class="texto" READONLY /><a href="javascript: void(0);" onclick="popGerente();">'.imagem('icones/usuarios.gif','Selecionar '.ucfirst($config['usuario']),'Clique neste ícone '.imagem('icones/usuarios.gif').' para selecionar '.($config['genero_usuario']=='o' ? 'um' : 'uma').' '.$config['usuario'].'.').'</a></td></tr>';
...
echo '<tr><td align="right" nowrap="nowrap">'.dica('Designados', 'Quais '.strtolower($config['usuarios']).' estão envolvid'.$config['genero_usuario'].'s.').'Designados:'.dicaF().'</td><td><table cellpadding=0 cellspacing=0><tr><td style="width:350px;"><div id="combo_usuarios">'.$saida_usuarios.'</div></td><td>'.botao_icone('usuarios.gif','Selecionar', 'selecionar '.$config['usuarios'].'.','popUsuarios()').'</td></tr></table></td></tr>';
...
echo '<tr><td align="right" nowrap="nowrap">'.dica(ucfirst($config['instrumentos']), 'Quais '.strtolower($config['instrumentos']).' estão envolvid'.$config['genero_instrumento'].'s.').ucfirst($config['instrumentos']).':'.dicaF().'</td><td><table cellpadding=0 cellspacing=0><tr><td style="width:350px;"><div id="combo_instrumentos">'.$saida_instrumentos.'</div></td><td>'.botao_icone('instrumento_p.png','Selecionar', 'selecionar '.$config['instrumentos'].'.','popInstrumentos()').'</td></tr></table></td></tr>';

echo '<tr><td align="right">'.dica('Descrição', 'Escreva uma descrição do patrocinador.').'Descrição:'.dicaF().'</td><td><table cellspacing=0 cellpadding=0 style="width:350px;"><tr><td><textarea data-gpweb-cmp="ckeditor" rows="10" name="patrocinador_descricao" id="patrocinador_descricao">'.$obj->patrocinador_descricao.'</textarea></td></tr></table></td></tr>';
echo '<tr><td align="right">'.dica('CPF', 'Escreva o CPF do patrocinador.<br><br>Embora não tenha impacto no funcionamento do Sistema, facilita a organização dos patrocinadores quando se trabalha com diversas '.$config['organizacao'].'.').'CPF:'.dicaF().'</td><td><input type="text" class="texto" name="patrocinador_cpf" value="'.$obj->patrocinador_cpf.'" maxlength="14" style="width:350px;" onchange="verificarCPF()" /></td></tr>';
echo '<tr><td align="right">'.dica('CNPJ', 'Escreva o CNPJ do patrocinador.<br><br>Embora não tenha impacto no funcionamento do Sistema, facilita a organização dos patrocinadores quando se trabalha com diversas '.$config['organizacao'].'.').'CNPJ:'.dicaF().'</td><td><input type="text" class="texto" name="patrocinador_cnpj" value="'.$obj->patrocinador_cnpj.'" maxlength="18" style="width:350px;" onchange="verificarCNPJ()" /></td></tr>';
echo '<tr><td align="right">'.dica('Endereço', 'Escreva o enderço do patrocinador.').'Endereço:'.dicaF().'</td><td><input type="text" class="texto" name="patrocinador_endereco1" value="'.$obj->patrocinador_endereco1.'" style="width:350px;" maxlength="255" /></td></tr>';
echo '<tr><td align="right">'.dica('Complemento do Endereço', 'Escreva o complemento do enderço do patrocinador.').'Complemento:'.dicaF().'</td><td><input type="text" class="texto" name="patrocinador_endereco2" value="'.$obj->patrocinador_endereco2.'" style="width:350px;" maxlength="255" /></td></tr>';
echo '<tr><td align="right">'.dica('Estado', 'Escolha na caixa de opção à direita o Estado do patrocinador.').'Estado:'.dicaF().'</td><td>'.selecionaVetor($estado, 'patrocinador_estado', 'class="texto" size="1" onchange="mudar_cidades();" style="width:350px;"', $obj->patrocinador_estado).'</td></tr>';
echo '<tr><td align="right">'.dica('Município', 'Selecione o município do patrocinador.').'Município:'.dicaF().'</td><td><div id="combo_cidade">'.selecionaVetor($cidades,'patrocinador_cidade', 'class="texto" style="width:350px;"', $obj->patrocinador_cidade).'</div></td></tr>';
echo '<tr><td align="right">'.dica('CEP', 'Escreva o CEP do patrocinador.').'CEP:'.dicaF().'</td><td><input type="text" class="texto" name="patrocinador_cep" value="'.$obj->patrocinador_cep.'" style="width:350px;" maxlength="15" /></td></tr>';
echo '<tr><td align="right">'.dica('País', 'Escolha na caixa de opção à direita o País do patrocinador.').'País:'.dicaF().'</td><td>'.selecionaVetor($paises, 'patrocinador_pais', 'size="1" style="width:350px;" class="texto"', ($obj->patrocinador_pais ? $obj->patrocinador_pais : 'BR')).'</td></tr>';

echo '<tr><td align="right">'.dica('E-mail', 'Escreva o e-mail do patrocinador.').'E-mail:'.dicaF().'</td><td><input type="text" class="texto" name="patrocinador_email" style="width:350px;" value="'.$obj->patrocinador_email.'" /></td></tr>';
echo '<tr><td align="right">'.dica('Página Web', 'Escreva a URL da página web do patrocinador.').'Web:'.dicaF().'</td><td><input type="text" class="texto" name="patrocinador_url" style="width:350px;" value="'.$obj->patrocinador_url.'" /></td></tr>';

echo '<tr><td align="right" nowrap="nowrap">'.dica('Telefone Comercial', 'Escreva o telefone comercial do patrocinador.<br><br>Embora não tenha impacto no funcionamento do Sistema, facilita a organização dos patrocinadores quando se trabalha com diversas '.$config['organizacao'].'.').'Telefone Comercial:'.dicaF().'</td><td>(<input type="text" class="texto" name="patrocinador_dddtel" value="'.$obj->patrocinador_dddtel.'" maxlength="6" size="1" />) <input type="text" class="texto" name="patrocinador_tel" value="'.$obj->patrocinador_tel.'" maxlength="30" style="width:305px;" /></td></tr>';
echo '<tr><td align="right" nowrap="nowrap">'.dica('Telefone Residencial', 'Escreva o telefone residencial do patrocinador.<br><br>Embora não tenha impacto no funcionamento do Sistema, facilita a organização dos patrocinadores quando se trabalha com diversas '.$config['organizacao'].'.').'Telefone Residencial:'.dicaF().'</td><td>(<input type="text" class="texto" name="patrocinador_dddtel2" value="'.$obj->patrocinador_dddtel2.'" maxlength="6" size="1" />) <input type="text" class="texto" name="patrocinador_tel2" value="'.$obj->patrocinador_tel2.'" maxlength="30" style="width:305px;" /></td></tr>';
echo '<tr><td align="right" nowrap="nowrap">'.dica('Fax', 'Escreva o Fax do patrocinador.<br><br>Embora não tenha impacto no funcionamento do Sistema, facilita a organização dos patrocinadores quando se trabalha com diversas '.$config['organizacao'].'.').'Fax:'.dicaF().'</td><td>(<input type="text" class="texto" name="patrocinador_dddfax" value="'.$obj->patrocinador_dddfax.'" maxlength="6" size="1" />) <input type="text" class="texto" name="patrocinador_fax" value="'.$obj->patrocinador_fax.'" maxlength="30" style="width:305px;" /></td></tr>';
echo '<tr><td align="right" nowrap="nowrap">'.dica('Celular', 'Escreva o celular do patrocinador.<br><br>Embora não tenha impacto no funcionamento do Sistema, facilita a organização dos patrocinadores quando se trabalha com diversas '.$config['organizacao'].'.').'Celular:'.dicaF().'</td><td>(<input type="text" class="texto" name="patrocinador_dddcel" value="'.$obj->patrocinador_dddcel.'" maxlength="6" size="1" />) <input type="text" class="texto" name="patrocinador_cel" value="'.$obj->patrocinador_cel.'" maxlength="30" style="width:305px;" /></td></tr>';
...
if ($swot_ativo) {
	echo '<tr '.(isset($patrocinador_mswot) && $patrocinador_mswot ? '' : 'style="display:none"').' id="mswot" ><td align="right" nowrap="nowrap">'.dica('Matriz SWOT', 'Caso o patrocinador seja específico de uma matriz SWOT neste campo deverá constar o nome da matriz SWOT').'Matriz SWOT:'.dicaF().'</td><td><table cellspacing=0 cellpadding=0><tr><td><input type="hidden" name="patrocinador_mswot" value="'.(isset($patrocinador_mswot) ? $patrocinador_mswot : '').'" /><input type="text" id="mswot_nome" name="mswot_nome" value="'.nome_mswot((isset($patrocinador_mswot) ? $patrocinador_mswot : null)).'" style="width:250px;" class="texto" READONLY /></td><td><a href="javascript: void(0);" onclick="popMSWOT();">'.imagem('../../../modulos/swot/imagens/mswot_p.png','Selecionar Matriz SWOT','Clique neste ícone '.imagem('../../../modulos/swot/imagens/mswot_p.png').' para selecionar uma matriz SWOT.').'</a></td></tr></table></td></tr>';
	echo '<tr '.(isset($patrocinador_swot) && $patrocinador_swot ? '' : 'style="display:none"').' id="swot" ><td align="right" nowrap="nowrap">'.dica('Campo SWOT', 'Caso o patrocinador seja específico de um campo de matriz SWOT neste campo deverá constar o nome do campo de matriz SWOT').'Campo SWOT:'.dicaF().'</td><td><table cellspacing=0 cellpadding=0><tr><td><input type="hidden" name="patrocinador_swot" value="'.(isset($patrocinador_swot) ? $patrocinador_swot : '').'" /><input type="text" id="swot_nome" name="swot_nome" value="'.nome_swot((isset($patrocinador_swot) ? $patrocinador_swot : null)).'" style="width:250px;" class="texto" READONLY /></td><td><a href="javascript: void(0);" onclick="popSWOT();">'.imagem('../../../modulos/swot/imagens/swot_p.png','Selecionar Campo SWOT','Clique neste ícone '.imagem('../../../modulos/swot/imagens/swot_p.png').' para selecionar um campo de matriz SWOT.').'</a></td></tr></table></td></tr>';
	}
else {
	echo '<input type="hidden" name="patrocinador_mswot" value="" id="mswot" /><input type="hidden" id="mswot_nome" name="mswot_nome" value="">';
	echo '<input type="hidden" name="patrocinador_swot" value="" id="swot" /><input type="hidden" id="swot_nome" name="swot_nome" value="">';
	}
...
if ($Aplic->profissional){
  ...
  $sql->limpar();
	...
	foreach($lista as $gestao_data){
		...
		elseif ($gestao_data['patrocinador_gestao_mswot']) echo '<td align=left>'.imagem('../../../modulos/swot/imagens/mswot_p.png').link_mswot($gestao_data['patrocinador_gestao_mswot']).'</td>';
...
if ($Aplic->profissional && $exibir['moeda']){
	...
	$sql->limpar();
	echo '<tr><td align="right" nowrap="nowrap">'.dica('Moeda', 'Escolha a moeda padrão utilizada.').'Moeda:'.dicaF().'</td><td>'.selecionaVetor($moedas, 'patrocinador_moeda', 'class=texto size=1', ($obj->patrocinador_moeda ? $obj->patrocinador_moeda : 1)).'</td></tr>';
	}	
...
function mudar_om(){
	...
	xajax_selecionar_om_ajax(cia_id,'patrocinador_cia','combo_cia', 'class="texto" size=1 style="width:350px;" onchange="javascript:mudar_om();"');
	}
...
function mudar_cidades(){
	xajax_selecionar_cidades_ajax(document.getElementById('patrocinador_estado').value,'patrocinador_cidade','combo_cidade', 'class="texto" size=1 style="width:350px;"', '<?php echo $obj->patrocinador_cidade ?>');
	}
...
function popObjetivo() {
	if (window.parent.gpwebApp) parent.gpwebApp.popUp('<?php echo ucfirst($config["objetivo"])?>', 500, 500, 'm=publico&a=selecionar&dialogo=1&chamar_volta=setObjetivo&tabela=objetivo&cia_id='+document.getElementById('patrocinador_cia').value, window.setObjetivo, window);
	else window.open('./index.php?m=publico&a=selecionar&dialogo=1&chamar_volta=setObjetivo&tabela=objetivo&cia_id='+document.getElementById('patrocinador_cia').value, '<?php echo ucfirst($config["objetivo"])?>','left=0,top=0,height=600,width=600,scrollbars=yes, resizable=yes');
	}
...
function popFator() {
	if (window.parent.gpwebApp) parent.gpwebApp.popUp('<?php echo ucfirst($config["fator"])?>', 500, 500, 'm=publico&a=selecionar&dialogo=1&chamar_volta=setFator&tabela=fator&cia_id='+document.getElementById('patrocinador_cia').value, window.setFator, window);
	else window.open('./index.php?m=publico&a=selecionar&dialogo=1&chamar_volta=setFator&tabela=fator&cia_id='+document.getElementById('patrocinador_cia').value, '<?php echo ucfirst($config["fator"])?>','left=0,top=0,height=600,width=600,scrollbars=yes, resizable=yes');
	}
...
function popMSWOT() {
	parent.gpwebApp.popUp('Matriz SWOT', 500, 500, 'm=swot&a=selecionar&dialogo=1&chamar_volta=setMSWOT&tabela=mswot&cia_id='+document.getElementById('patrocinador_cia').value, window.setMSWOT, window);
	}
...
function popSWOT() {
	parent.gpwebApp.popUp('Campo SWOT', 500, 500, 'm=swot&a=selecionar&dialogo=1&chamar_volta=setSWOT&tabela=swot&cia_id='+document.getElementById('patrocinador_cia').value, window.setSWOT, window);
	}
...
function popArquivo() {
	if (window.parent.gpwebApp) parent.gpwebApp.popUp('Arquivo', 500, 500, 'm=publico&a=selecionar&dialogo=1&chamar_volta=setArquivo&tabela=arquivo&cia_id='+document.getElementById('patrocinador_cia').value, window.setArquivo, window);
	else window.open('./index.php?m=publico&a=selecionar&dialogo=1&chamar_volta=setArquivo&tabela=arquivo&cia_id='+document.getElementById('patrocinador_cia').value, 'Arquivo','left=0,top=0,height=600,width=600,scrollbars=yes, resizable=yes');
	}
...
function limpar_tudo(){
	...
	<?php
	if($swot_ativo) {
		echo 'document.env.mswot_nome.value = \'\';	document.env.patrocinador_mswot.value = null;';
		echo 'document.env.swot_nome.value = \'\';	document.env.patrocinador_swot.value = null;';
		}
