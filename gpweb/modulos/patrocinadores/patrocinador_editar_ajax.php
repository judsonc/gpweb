...
function atualizar_gestao($patrocinador_id=0, $uuid=''){
  ...
  $saida='';
	...
	foreach($lista as $gestao_data){
		...
		elseif (isset($gestao_data['patrocinador_gestao_mswot']) && $gestao_data['patrocinador_gestao_mswot']) $saida.= '<td align=left>'.imagem('../../../modulos/swot/imagens/mswot_p.png').link_mswot($gestao_data['patrocinador_gestao_mswot']).'</td>';
