...
echo '<tr><td align="right">'.dica('Nome do Ação Social', 'Toda ação social necessita ter um nome para identificação.').'Nome:'.dicaF().'</td><td><input type="text" name="social_acao_nome" value="'.$obj->social_acao_nome.'" style="width:600px;" class="texto" /> *</td></tr>';
