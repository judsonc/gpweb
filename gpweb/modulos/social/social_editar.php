...
echo '<tr><td align="right">'.dica('Nome do Programa Social', 'Todo programa social necessita ter um nome para identificação.').'Nome:'.dicaF().'</td><td><input type="text" name="social_nome" value="'.$obj->social_nome.'" style="width:600px;" class="texto" /> *</td></tr>';
