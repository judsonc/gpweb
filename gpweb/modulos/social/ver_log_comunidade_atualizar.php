...
echo '<tr><td align="right">'.dica('Valor Gasto', 'Valor gasto na social.').'Valor Gasto:'.dicaF().'</td><td><input type="text" style="text-align:right;" class="texto" onkeypress="return entradaNumerica(event, this, true, true);" name="social_comunidade_log_custo" value="'.($log->social_comunidade_log_custo ? number_format($log->social_comunidade_log_custo, 2, ',', '.') : '').'" size="40" /></td></tr>';  
