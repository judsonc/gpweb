...
echo $cabecalho;
echo '<tr><td align=center><h1>Área dos Estados em que se executou a ação social</h1></td></tr>';
...
if (count($vetor_estado)){
	...
	echo '<td style="border-style:solid;border-width:1px; background: #'.$config['porcentagem_0'].';">&nbsp;&nbsp;&nbsp;&nbsp;</td><td>'.dica('0%', 'Percentagem concluída em 0%.').'0%'.dicaF().'</td><td>&nbsp;&nbsp;</td>';
	echo '<td style="border-style:solid;border-width:1px; background: #'.$config['porcentagem_0_10'].';">&nbsp;&nbsp;&nbsp;&nbsp;</td><td>'.dica('0% a 10%', 'Percentagem concluída entre 0% aberto e 10% aberto.').'<10%'.dicaF().'</td><td>&nbsp</td>';
	echo '<td style="border-style:solid;border-width:1px; background: #'.$config['porcentagem_10_20'].';">&nbsp;&nbsp;&nbsp;&nbsp;</td><td>'.dica('10% a 20%', 'Percentagem concluída entre 10% fechado e 20% aberto.').'10%'.dicaF().'</td><td>&nbsp;</td>';
	echo '<td style="border-style:solid;border-width:1px; background: #'.$config['porcentagem_20_30'].';">&nbsp;&nbsp;&nbsp;&nbsp;</td><td>'.dica('20% a 30%', 'Percentagem concluída entre 20% fechado e 30% aberto.').'20%'.dicaF().'</td><td>&nbsp;</td>';
	echo '<td style="border-style:solid;border-width:1px; background: #'.$config['porcentagem_30_40'].';">&nbsp;&nbsp;&nbsp;&nbsp;</td><td>'.dica('30% a 40%', 'Percentagem concluída entre 30% fechado e 40% aberto.').'30%'.dicaF().'</td><td>&nbsp;</td>';
	echo '<td style="border-style:solid;border-width:1px; background: #'.$config['porcentagem_40_50'].';">&nbsp;&nbsp;&nbsp;&nbsp;</td><td>'.dica('40% a 50%', 'Percentagem concluída entre 40% fechado e 50% aberto.').'40%'.dicaF().'</td><td>&nbsp;</td>';
	echo '<td style="border-style:solid;border-width:1px; background: #'.$config['porcentagem_50_60'].';">&nbsp;&nbsp;&nbsp;&nbsp;</td><td>'.dica('50% a 60%', 'Percentagem concluída entre 50% fechado e 60% aberto.').'50%'.dicaF().'</td><td>&nbsp;</td>';
	echo '<td style="border-style:solid;border-width:1px; background: #'.$config['porcentagem_60_70'].';">&nbsp;&nbsp;&nbsp;&nbsp;</td><td>'.dica('60% a 70%', 'Percentagem concluída entre 60% fechado e 70% aberto.').'60%'.dicaF().'</td><td>&nbsp;</td>';
	echo '<td style="border-style:solid;border-width:1px; background: #'.$config['porcentagem_70_80'].';">&nbsp;&nbsp;&nbsp;&nbsp;</td><td>'.dica('70% a 80%', 'Percentagem concluída entre 70% fechado e 80% aberto.').'70%'.dicaF().'</td><td>&nbsp;</td>';
	echo '<td style="border-style:solid;border-width:1px; background: #'.$config['porcentagem_80_90'].';">&nbsp;&nbsp;&nbsp;&nbsp;</td><td>'.dica('80% a 90%', 'Percentagem concluída entre 80% fechado e 90% aberto.').'80%'.dicaF().'</td><td>&nbsp;</td>';
	echo '<td style="border-style:solid;border-width:1px; background: #'.$config['porcentagem_90_100'].';">&nbsp;&nbsp;&nbsp;&nbsp;</td><td>'.dica('90% a 100%', 'Percentagem concluída entre 90% fechado e 100% aberto.').'90%'.dicaF().'</td><td>&nbsp;</td>';
	echo '<td style="border-style:solid;border-width:1px; background: #'.$config['porcentagem_100'].';">&nbsp;&nbsp;&nbsp;&nbsp;</td><td>'.dica('100%', 'Percentagem concluída em 100%.').'&nbsp;100%'.dicaF().'</td><td>&nbsp;&nbsp;</td>';
	echo '</tr></table></td></tr>';

	echo '</table></td></tr>';
	echo '<script>initialize();</script>';
	}
else echo '<tr><td align=center><h1>Não foi encontrado nenhum valor na base de dados</h1></td></tr>';	
echo '</table>';
