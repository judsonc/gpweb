...
echo '<tr><td align="right">'.dica('Nome do Comunidade', 'Toda comunidade necessita ter um nome para identificação.').'Nome:'.dicaF().'</td><td><input type="text" name="social_comunidade_nome" id="social_comunidade_nome" value="'.$obj->social_comunidade_nome.'" style="width:600px;" class="texto" /> *</td></tr>';
