...
if ($renomear){
	...
	$sql->adTabela('modelos_anexos');
	$sql->adAtualizar('nome_fantasia', $novo_nome);
	$sql->adOnde('modelo_anexo_id='.$modelo_anexo_id);
...
echo '<tr><td colspan=2 align="center"><input type="text" style="width:200px;" class="texto" name="novo_nome" value="'.($anexo['nome_fantasia'] ? $anexo['nome_fantasia'] : $anexo['nome']).'"></td></tr>';
echo '<tr><td colspan=2 align="center">&nbsp;</td></tr>';
echo '<tr><td colspan="2" align="center"><table><tr><td><a class="botao" href="javascript:void(0);" onclick="javascript:window.close();"><span><b>Cancelar</b></span></a></td><td width="100">&nbsp;</td><td><a class="botao" href="javascript:void(0);" onclick="javascript:env.renomear.value=1; env.submit();"><span><b>Confirmar</b></span></a></td></tr></table></td></tr>';
echo '<tr><td colspan=2>&nbsp;</td></tr>';
echo '</table>'; 
