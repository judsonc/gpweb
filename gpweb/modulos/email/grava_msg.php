...
if ($Aplic->profissional){
	...
	elseif ($linha['msg_gestao_objetivo'] && $qnt==1) $endereco='m=praticas&a=obj_estrategico_ver&objetivo_id='.$linha['msg_gestao_objetivo'];
	elseif ($linha['msg_gestao_fator'] && $qnt==1) $endereco='m=praticas&a=fator_ver&fator_id='.$linha['msg_gestao_fator'];
	...
	elseif ($linha['msg_gestao_mswot'] && $qnt==1) $endereco='m=swot&a=mswot_ver&mswot_id='.$linha['msg_gestao_mswot'];
	...
	elseif ($linha['msg_gestao_instrumento'] && $qnt==1) $endereco='m=instrumento&a=instrumento_ver&instrumento_id='.$linha['msg_gestao_instrumento'];
...
elseif ($msg_objetivo) $Aplic->redirecionar('m=praticas&a=obj_estrategico_ver&objetivo_id='.$msg_objetivo);
...
elseif ($msg_fator) $Aplic->redirecionar('m=praticas&a=fator_ver&fator_id='.$msg_fator);
