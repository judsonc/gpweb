...
echo '<input type="hidden" id="despacho_id" name="despacho_id" value="" /></table></td><td id="adicionar_despacho" style="display:"><a href="javascript: void(0);" onclick="incluir_despacho();">'.imagem('icones/adicionar_g.png','Incluir','Clique neste ícone '.imagem('icones/adicionar.png').' para incluir a despacho.').'</a></td>';
echo '<td id="confirmar_despacho" style="display:none"><a href="javascript: void(0);" onclick="document.getElementById(\'despacho_id\').value=0; document.getElementById(\'despacho_nome\').value=\'\'; CKEDITOR.instances[\'despacho_texto\'].setData(\'\'); document.getElementById(\'adicionar_despacho\').style.display=\'\';	document.getElementById(\'confirmar_despacho\').style.display=\'none\';">'.imagem('icones/cancelar_g.png','Cancelar','Clique neste ícone '.imagem('icones/cancelar.png').' para cancelar a edição da despacho .').'</a><a href="javascript: void(0);" onclick="incluir_despacho();">'.imagem('icones/ok_g.png','Confirmar','Clique neste ícone '.imagem('icones/ok.png').' para confirmar a edição da despacho.').'</a></td></tr>';
echo '</table></td></tr>';
