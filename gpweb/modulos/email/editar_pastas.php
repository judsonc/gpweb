...
echo '<input type="hidden" id="pasta_id" name="pasta_id" value="" /></table></td><td id="adicionar_pasta" style="display:"><a href="javascript: void(0);" onclick="incluir_pasta();">'.imagem('icones/adicionar_g.png','Incluir','Clique neste ícone '.imagem('icones/adicionar.png').' para incluir a pasta.').'</a></td>';
echo '<td id="confirmar_pasta" style="display:none"><a href="javascript: void(0);" onclick="document.getElementById(\'pasta_id\').value=0;document.getElementById(\'nome\').value=\'\'; document.getElementById(\'adicionar_pasta\').style.display=\'\';	document.getElementById(\'confirmar_pasta\').style.display=\'none\';">'.imagem('icones/cancelar_g.png','Cancelar','Clique neste ícone '.imagem('icones/cancelar.png').' para cancelar a edição da pasta .').'</a><a href="javascript: void(0);" onclick="incluir_pasta();">'.imagem('icones/ok_g.png','Confirmar','Clique neste ícone '.imagem('icones/ok.png').' para confirmar a edição da pasta.').'</a></td></tr>';
