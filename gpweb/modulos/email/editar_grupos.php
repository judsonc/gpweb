...
echo '<input type="hidden" id="grupo_id" name="grupo_id" value="" /></table></td><td id="adicionar_grupo" style="display:"><a href="javascript: void(0);" onclick="incluir_grupo();">'.imagem('icones/adicionar_g.png','Incluir','Clique neste ícone '.imagem('icones/adicionar.png').' para incluir o grupo.').'</a></td>';
echo '<td id="confirmar_grupo" style="display:none"><a href="javascript: void(0);" onclick="document.getElementById(\'grupo_id\').value=0;document.getElementById(\'grupo_descricao\').value=\'\'; document.getElementById(\'adicionar_grupo\').style.display=\'\';	document.getElementById(\'confirmar_grupo\').style.display=\'none\';">'.imagem('icones/cancelar_g.png','Cancelar','Clique neste ícone '.imagem('icones/cancelar.png').' para cancelar a edição do grupo .').'</a><a href="javascript: void(0);" onclick="incluir_grupo();">'.imagem('icones/ok_g.png','Confirmar','Clique neste ícone '.imagem('icones/ok.png').' para confirmar a edição do grupo.').'</a></td></tr>';
echo '</table></td></tr>';
