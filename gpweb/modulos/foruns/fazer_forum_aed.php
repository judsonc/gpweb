...
if ($Aplic->profissional && getParam($_REQUEST, 'uuid', null)){
	...
	elseif ($linha['forum_gestao_objetivo'] && $qnt==1) $endereco='m=praticas&a=obj_estrategico_ver&objetivo_id='.$linha['forum_gestao_objetivo'];
	elseif ($linha['forum_gestao_fator'] && $qnt==1) $endereco='m=praticas&a=fator_ver&fator_id='.$linha['forum_gestao_fator'];
	...
	elseif ($linha['forum_gestao_mswot'] && $qnt==1) $endereco='m=swot&a=mswot_ver&mswot_id='.$linha['forum_gestao_mswot'];
	elseif ($linha['forum_gestao_operativo'] && $qnt==1) $endereco='m=operativo&a=operativo_ver&operativo_id='.$linha['forum_operativo'];
	elseif ($linha['forum_gestao_instrumento'] && $qnt==1) $endereco='m=instrumento&a=instrumento_ver&instrumento_id='.$linha['forum_gestao_instrumento'];
