...
if ($contatos_enviados == 1) {
	...
	echo '<script type="text/javascript">if(parent && parent.gpwebApp){parent.gpwebApp._popupCallback(\''.$contatos_selecionados_id.'\');} else {'.$chamarVolta_string.'; self.close();}</script>';
	}
