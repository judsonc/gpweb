...
if (!$ok) {
  ...
  function cancelarSelecao(){
	...
	if (!$Aplic->profissional) echo '<tr><td>'.botao('cancelar', '', '','','javascript:cancelarSelecao()').'</td></tr>';
	} 
...
<?php if ($tabela=='pratica_indicador') { ?>
	...
	function popObjetivo() {
		...
		*/
		...
		window.open('./index.php?m=publico&a=selecionar&dialogo=1&chamar_volta=setObjetivo&tabela=objetivo&cia_id='+document.getElementById('cia_id').value, 'Objetivo','left=0,top=0,height=600,width=600,scrollbars=yes, resizable=yes');
	...
	function popFator() {
		...
		*/
		window.open('./index.php?m=publico&a=selecionar&dialogo=1&chamar_volta=setFator&tabela=fator&cia_id='+document.getElementById('cia_id').value, 'Fator','left=0,top=0,height=600,width=600,scrollbars=yes, resizable=yes');
		}
