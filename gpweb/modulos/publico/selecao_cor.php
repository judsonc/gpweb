...
//echo '<script type="text/javascript">function setFechar(cor){window.opener.'.$chamarVolta.'(cor); window.close();}</script>';

echo '<script type="text/javascript">function setFechar(cor){
