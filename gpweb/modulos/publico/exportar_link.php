...
else if ($tipo=='mswot') $endereco='m=swot&a=mswot_exibir&jquery=1&dialogo=1&mswot_id='.$id;
...
elseif ($tipo=='generico') $endereco=$Aplic->getPosicao().'&dialogo=1'.(!isset($posicao['cia_id']) && $cia_id ? '&cia_id='.$cia_id : '');
else $endereco='';
