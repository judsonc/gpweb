...
echo '<td align="left">'.dica('Texto a ser Pesquisado', 'Insira neste campo o texto a ser procurado dentro do '.$config['gpweb'].'.').'<input class="texto" size="70" type="text" id="palavraChave" name="palavraChave" value="'.(isset($_REQUEST['palavraChave']) ? stripslashes(getParam($_REQUEST, 'palavraChave', null)) : '').'" />'.dicaF().'</td>';
