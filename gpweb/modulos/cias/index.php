...
if (!$dialogo && $Aplic->profissional){
	$botoesTitulo = new CBlocoTitulo(ucfirst($config['organizacoes']), 'organizacao.png', $m, $m.'.'.$a);
  ...
  $saida.='<table cellspacing=0 cellpadding=0>';
	...
	$saida.='<tr><td><table cellspacing=0 cellpadding=0>'.$procurar_om.($tab!=3 ? $pesquisar.$selecionar_tipos : '').'</table></td><td><table cellspacing=0 cellpadding=0>'.$novo.$imprimir.'</table></td></tr></table>';
	$saida.= '</div></div>';
