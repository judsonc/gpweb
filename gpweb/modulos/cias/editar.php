...
if ($cia_id) $podeEditar = ($podeEditar && permiteEditarCia($obj->cia_acesso, $cia_id));
...
if ($obj && $cia_id && !permiteEditarCia($obj->cia_acesso, $cia_id)) $Aplic->redirecionar('m=publico&a=acesso_negado');
