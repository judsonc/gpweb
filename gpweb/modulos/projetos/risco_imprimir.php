...
$sql->esqUnir(($baseline_id ? 'baseline_' : '').'projetos', 'projetos', 'projeto_id=projeto_risco_projeto');
$sql->adCampo('projeto_risco.*, projeto_id, projeto_cia, projeto_nome, projeto_codigo');
...
$sql->adOnde('artefato_tipo_arquivo=\'gerenciamento_risco.html\'');
$linha = $sql->linha();
$sql->limpar();
