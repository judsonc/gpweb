...
$sql->esqUnir(($baseline_id ? 'baseline_' : '').'projetos', 'projetos', 'projeto_id=projeto_embasamento_projeto');
$sql->adCampo('projeto_embasamento.*, projeto_id, projeto_cia, projeto_nome, projeto_codigo');
$sql->adOnde('projeto_embasamento_projeto = '.(int)$projeto_id);
...
$sql->adOnde('artefato_tipo_arquivo=\'embasamento_projeto.html\'');
$linha = $sql->linha();
$sql->limpar();
