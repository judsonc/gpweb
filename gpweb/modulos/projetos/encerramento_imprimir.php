...
$sql->esqUnir(($baseline_id ? 'baseline_' : '').'projetos', 'projetos', 'projeto_id=projeto_encerramento_projeto');
$sql->adCampo('projeto_encerramento.*,projeto_id, projeto_cia, projeto_nome, projeto_codigo');
...
$sql->adOnde('artefato_tipo_arquivo=\'termo_encerramento.html\'');
$linha = $sql->linha();
$sql->limpar();
