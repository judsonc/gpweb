...
echo '<tr><td align="right" nowrap="nowrap">'.dica('Possível Nome d'.$config['genero_projeto'].' '.$config['projeto'], 'Tod'.$config['genero_projeto'].' '.$config['projeto'].' necessita ter um nome para identificação.').'Nome d'.$config['genero_projeto'].' '.$config['projeto'].':'.dicaF().'</td><td><input type="text" name="projeto_viabilidade_nome" value="'.($obj->projeto_viabilidade_nome ? $obj->projeto_viabilidade_nome : $demanda->demanda_nome).'" style="width:600px;" class="texto" /> *</td></tr>';
