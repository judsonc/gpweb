...
echo '<td id="adicionar_evento" style="display:"><a href="javascript: void(0);" onclick="inserir_evento();">'.imagem('icones/adicionar_g.png','Incluir','Clique neste ícone '.imagem('icones/adicionar.png').' para incluir o evento.').'</a></td>';
echo '<td id="confirmar_evento" style="display:none"><a href="javascript: void(0);" onclick="limpar();">'.imagem('icones/cancelar_g.png','Cancelar','Clique neste ícone '.imagem('icones/cancelar.png').' para cancelar a edição do evento.').'</a><a href="javascript: void(0);" onclick="inserir_evento();">'.imagem('icones/ok_g.png','Confirmar','Clique neste ícone '.imagem('icones/ok.png').' para confirmar a edição do evento.').'</a></td></tr>';
