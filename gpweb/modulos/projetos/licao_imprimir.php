...
$licao_id = getParam($_REQUEST, 'licao_id', 0);
$baseline_id = getParam($_REQUEST, 'baseline_id', 0);

$sql = new BDConsulta();

$sql->adTabela('licao');
$sql->esqUnir(($baseline_id ? 'baseline_' : '').'projetos','projetos','licao_projeto=projeto_id');
$sql->adCampo('licao.*, projeto_id, projeto_cia, projeto_nome, projeto_codigo');
...
$sql->adOnde('artefato_tipo_arquivo=\'licoes_aprendidas.html\'');
$linha = $sql->linha();
$sql->limpar();
