...
$sql = new BDConsulta();
$sql->adTabela('ata');
$sql->esqUnir(($baseline_id ? 'baseline_' : '').'projetos', 'projetos', 'projeto_id=ata_projeto');
$sql->adCampo('ata.*, projeto_id, projeto_cia, projeto_nome, projeto_codigo');
...
if ($Aplic->profissional){
	$barra=codigo_barra('projeto', $dados['projeto_id'], $baseline_id);
...
$sql->adOnde('artefato_tipo_arquivo=\'ata_reuniao.html\'');
$linha = $sql->linha();
$sql->limpar();
