...
if ($Aplic->profissional){
		...
		elseif ($objetivo_id) $sql->adOnde('projeto_gestao_objetivo='.(int)$objetivo_id);
		elseif ($fator_id) $sql->adOnde('projeto_gestao_fator='.(int)$fator_id);
		...
		elseif ($mswot_id) $sql->adOnde('projeto_gestao_mswot='.(int)$mswot_id);
		...
		if ($pg_perspectiva_id) $sql->adOnde('projeto_perspectiva='.(int)$pg_perspectiva_id);
		elseif ($tema_id) $sql->adOnde('projeto_tema='.(int)$tema_id);
		elseif ($objetivo_id) $sql->adOnde('projeto_objetivo_estrategico='.(int)$objetivo_id);
		elseif ($fator_id) $sql->adOnde('projeto_fator='.(int)$fator_id);
		elseif ($pg_estrategia_id) $sql->adOnde('projeto_estrategia='.(int)$pg_estrategia_id);
		elseif ($pg_meta_id) $sql->adOnde('projeto_meta='.(int)$pg_meta_id);
		elseif ($pratica_id) $sql->adOnde('projeto_pratica='.(int)$pratica_id);
		elseif ($pratica_indicador_id) $sql->adOnde('projeto_indicador='.(int)$pratica_indicador_id);
		elseif ($plano_acao_id) $sql->adOnde('projeto_acao='.(int)$plano_acao_id);
		}	
