...
echo '<font color="#5c8526" face="Arial, Helvetica, sans-serif" style="font-size: 12pt;" size="5"><b>'.$config['gpweb'].' v. '.$_versao_maior.'.'.$_versao_menor.'.'.$_versao_revisao.'</b></font>';
...
echo '</ul>';
echo '<br><p align="LEFT"><font color="#5c8526"><font face="Arial, Helvetica, sans-serif"><font style="font-size: 12pt;" size="5">Principais Funcionalidades do '.$config['gpweb'].'</font></font></font></p>';
echo '<ul>';
