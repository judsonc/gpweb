...
echo '<tr><td align="right">'.dica('Limitar Administrador', 'Caso deseje que o adminitrador do o '.(isset($config['gpweb']) ? $config['gpweb'] : 'gpweb').' seja limitado quanto a alterações nas configurações do sistema, esta opção deve ser marcada.').'Limitar administrador?'.dicaF().'</td><td align="left"><input type="checkbox" name="bronze" value="1" title="Caso deseje que o adminitrador do o '.(isset($config['gpweb']) ? $config['gpweb'] : 'gpweb').' seja limitado quanto a alterações nas configurações do sistema, esta opção deve ser marcada." /></td></tr>';
