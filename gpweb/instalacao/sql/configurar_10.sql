UPDATE config SET config_valor="organização" WHERE config_nome="organizacao";
UPDATE config SET config_valor="organizações" WHERE config_nome="organizacoes";
UPDATE config SET config_valor="org." WHERE config_nome="om";
...
UPDATE config SET config_valor="organização" WHERE config_nome="nome_om";
UPDATE config SET config_valor="10" WHERE config_nome="militar";

INSERT INTO cias (cia_id, cia_superior, cia_responsavel, cia_nome, cia_nome_completo, cia_codigo, cia_cnpj, cia_inscricao_estadual, cia_tel1, cia_tel2, cia_fax, cia_endereco1, cia_endereco2, cia_cidade, cia_estado, cia_cep, cia_pais, cia_url, cia_descricao, cia_tipo, cia_email, cia_customizado, cia_contatos, cia_acesso, cia_cabacalho, cia_ug, cia_ug2, cia_nup, cia_qnt_nup, cia_qnt_nr, cia_prefixo, cia_sufixo, cia_logo, cia_ativo) VALUES
  (1,1,1,'Organização Exemplo','Organização Exemplo',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,4314902,'RS',NULL,'BR',NULL,NULL,0,NULL,NULL,NULL,0,'<p style=\"text-align:center\"><strong>ORGANIZAÇÃO EXEMPLO</strong></p>\n',NULL,NULL,NULL,0,0,NULL,NULL,'1/sisp.gif',1);
