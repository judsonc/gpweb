...
CREATE TABLE custo (
  ...
  custo_moeda INTEGER(100) UNSIGNED DEFAULT 1,  
	custo_cotacao DECIMAL(6,5) UNSIGNED DEFAULT 1.00000, 
...
CREATE TABLE instrumento_log (
  ...
  instrumento_log_horas DECIMAL(20,5) UNSIGNED DEFAULT 0,
  instrumento_log_descricao TEXT,
  instrumento_log_custo DECIMAL(20,5) UNSIGNED DEFAULT 0,
  ...
  instrumento_log_inicio DATETIME DEFAULT NULL,
	...
	instrumento_log_duracao DECIMAL(20,5) UNSIGNED DEFAULT NULL,
  instrumento_log_percentagem DECIMAL(20,5) UNSIGNED DEFAULT NULL,
...
CREATE TABLE tema_log (
  ...
  tema_log_horas DECIMAL(20,5) UNSIGNED DEFAULT 0,
  tema_log_descricao TEXT,
  tema_log_custo DECIMAL(20,5) UNSIGNED DEFAULT 0,
...
CREATE TABLE ata (
  ...
  CONSTRAINT ata_objetivo FOREIGN KEY (ata_objetivo) REFERENCES objetivo (objetivo_id) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT ata_fator FOREIGN KEY (ata_fator) REFERENCES fator (fator_id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE assinatura_atesta (
  ...
  assinatura_atesta_projeto TINYINT(1) DEFAULT 0,
	...
	assinatura_atesta_viabilidade TINYINT(1) DEFAULT 0,
	assinatura_atesta_abertura TINYINT(1) DEFAULT 0,
...
CREATE TABLE ata_participante (
  ...
  CONSTRAINT ata_participante_atesta FOREIGN KEY (ata_participante_atesta) REFERENCES assinatura_atesta (assinatura_atesta_id) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT ata_participante_atesta_opcao FOREIGN KEY (ata_participante_atesta_opcao) REFERENCES assinatura_atesta_opcao (assinatura_atesta_opcao_id) ON DELETE SET NULL ON UPDATE CASCADE
)ENGINE=InnoDB CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
CREATE TABLE perspectiva_log (
  ...
  perspectiva_log_horas DECIMAL(20,5) UNSIGNED DEFAULT 0,
  perspectiva_log_descricao TEXT,
  perspectiva_log_custo DECIMAL(20,5) UNSIGNED DEFAULT 0,
...
CREATE TABLE objetivo (
  ...
  objetivo_superior INTEGER(100) UNSIGNED DEFAULT NULL,
  objetivo_indicador INTEGER(100) UNSIGNED DEFAULT NULL,
  objetivo_nome VARCHAR(250) DEFAULT NULL,
  ...
  objetivo_composicao TINYINT(1) DEFAULT 0,
  ...
  KEY objetivo_superior (objetivo_superior),
  ...
  CONSTRAINT objetivo_superior FOREIGN KEY (objetivo_superior) REFERENCES objetivo (objetivo_id) ON DELETE SET NULL ON UPDATE CASCADE,
  ...
  CONSTRAINT objetivo_dept FOREIGN KEY (objetivo_dept) REFERENCES depts (dept_id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE fator (
  ...
  fator_superior INTEGER(100) UNSIGNED DEFAULT NULL,
  fator_nome TEXT,
  ...
  KEY fator_superior (fator_superior),
  ...
  CONSTRAINT fator_dept FOREIGN KEY (fator_dept) REFERENCES depts (dept_id) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT fator_superior FOREIGN KEY (fator_superior) REFERENCES fator (fator_id) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE meta_meta (
	...
	meta_meta_valor_meta DECIMAL(20,5) DEFAULT '0.000',
	meta_meta_valor_meta_boa DECIMAL(20,5) DEFAULT NULL,
	meta_meta_valor_meta_regular DECIMAL(20,5) DEFAULT NULL,
	meta_meta_valor_meta_ruim DECIMAL(20,5) DEFAULT NULL,
...
CREATE TABLE tarefas (
  ...
  tarefa_realizado DECIMAL(20,5) UNSIGNED DEFAULT 0,
	...
	tarefa_duracao_manual DECIMAL(20,5) UNSIGNED NULL DEFAULT '0.000',
...
CREATE TABLE pratica_indicador_meta (
	...
	pratica_indicador_meta_valor_referencial DECIMAL(20,5) DEFAULT NULL,
	pratica_indicador_meta_valor_meta DECIMAL(20,5) DEFAULT '0.000',
	pratica_indicador_meta_valor_meta_boa DECIMAL(20,5) DEFAULT NULL,
	pratica_indicador_meta_valor_meta_regular DECIMAL(20,5) DEFAULT NULL,
	pratica_indicador_meta_valor_meta_ruim DECIMAL(20,5) DEFAULT NULL,
...
CREATE TABLE arquivo (
  ...
  CONSTRAINT arquivo_superior FOREIGN KEY (arquivo_superior) REFERENCES arquivo (arquivo_id) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE arquivo_historico (
  ...
  KEY arquivo_principal_indicador (arquivo_principal_indicador),
  KEY arquivo_moeda (arquivo_moeda),
  CONSTRAINT arquivo_historico_usuario_upload FOREIGN KEY (arquivo_usuario_upload) REFERENCES usuarios (usuario_id) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  CONSTRAINT arquivo_historico_superior FOREIGN KEY (arquivo_superior) REFERENCES arquivo (arquivo_id) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE baseline_tarefa_log (
  ...
  tarefa_log_horas DECIMAL(20,5) UNSIGNED DEFAULT 0,
  tarefa_log_data DATETIME DEFAULT NULL,
  tarefa_log_custo DECIMAL(20,5) UNSIGNED DEFAULT 0,
  ...
  tarefa_log_reg_mudanca_duracao DECIMAL(20,3) UNSIGNED DEFAULT NULL,
  ...
  tarefa_log_reg_mudanca_percentagem DECIMAL(20,5) UNSIGNED DEFAULT NULL,
  tarefa_log_reg_mudanca_realizado DECIMAL(20,5) UNSIGNED DEFAULT NULL,
...
CREATE TABLE baseline_tarefa_custos (
  ...
  tarefa_custos_moeda INTEGER(100) UNSIGNED DEFAULT 1, 
	tarefa_custos_cotacao DECIMAL(6,5) UNSIGNED DEFAULT 1.00000,
...
CREATE TABLE baseline_tarefa_gastos (
  ...
  tarefa_gastos_bdi DECIMAL(20,5) UNSIGNED DEFAULT 0,
	...
	tarefa_gastos_cotacao DECIMAL(6,5) UNSIGNED DEFAULT 1.00000, 
...
CREATE TABLE brainstorm_fatores (
  ...
  CONSTRAINT brainstorm_fatores_fk1 FOREIGN KEY (pg_fator_critico_id) REFERENCES fator (fator_id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE brainstorm_objetivos (
  ...
  CONSTRAINT brainstorm_objetivos_fk1 FOREIGN KEY (pg_objetivo_estrategico_id) REFERENCES objetivo (objetivo_id),
...
CREATE TABLE causa_efeito_fatores (
  ...
  CONSTRAINT causa_efeito_fatores_fk1 FOREIGN KEY (pg_fator_critico_id) REFERENCES fator (fator_id) ON DELETE CASCADE ON UPDATE CASCADE
)ENGINE=InnoDB CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
CREATE TABLE causa_efeito_objetivos (
  ...
  CONSTRAINT causa_efeito_objetivos_fk1 FOREIGN KEY (pg_objetivo_estrategico_id) REFERENCES objetivo (objetivo_id) ON DELETE CASCADE ON UPDATE CASCADE
)ENGINE=InnoDB CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
CREATE TABLE checklist_dados (
  ...
  pratica_indicador_valor_valor DECIMAL(20,5) DEFAULT NULL,
...
CREATE TABLE estrategias_log (
  ...
  pg_estrategia_log_horas DECIMAL(20,5) UNSIGNED DEFAULT 0,
  pg_estrategia_log_descricao TEXT,
  pg_estrategia_log_custo DECIMAL(20,5) UNSIGNED DEFAULT 0,
  ...
  pg_estrategia_log_metodo INTEGER(100) UNSIGNED DEFAULT NULL,
	...
	pg_estrategia_log_reg_mudanca_percentagem DECIMAL(20,5) UNSIGNED DEFAULT NULL,
...
CREATE TABLE fator_log (
  fator_log_id INTEGER(100) UNSIGNED NOT NULL AUTO_INCREMENT,
  fator_log_fator INTEGER(100) UNSIGNED DEFAULT NULL,
  fator_log_criador INTEGER(100) UNSIGNED DEFAULT NULL,
  fator_log_horas DECIMAL(20,5) UNSIGNED DEFAULT 0.00000,
  fator_log_descricao TEXT,
  fator_log_custo DECIMAL(20,5) UNSIGNED DEFAULT 0.00000,
  fator_log_nd VARCHAR(11) DEFAULT NULL,
  fator_log_categoria_economica VARCHAR(1) DEFAULT NULL,
  fator_log_grupo_despesa VARCHAR(1) DEFAULT NULL,
  fator_log_modalidade_aplicacao VARCHAR(2) DEFAULT NULL,
  fator_log_metodo INTEGER(100) UNSIGNED DEFAULT NULL,
  fator_log_exercicio INTEGER(4) UNSIGNED DEFAULT NULL,
  fator_log_problema TINYINT(1) DEFAULT 0,
  fator_log_referencia INTEGER(11) DEFAULT NULL,
  fator_log_nome VARCHAR(200) DEFAULT NULL,
  fator_log_data DATETIME DEFAULT NULL,
  fator_log_url_relacionada VARCHAR(250) DEFAULT NULL,
  fator_log_acesso INTEGER(100) DEFAULT 0,
  PRIMARY KEY (fator_log_id),
  KEY fator_log_fator (fator_log_fator),
  KEY fator_log_criador (fator_log_criador),
  CONSTRAINT fator_log_criador FOREIGN KEY (fator_log_criador) REFERENCES usuarios (usuario_id) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT fator_log_fator FOREIGN KEY (fator_log_fator) REFERENCES fator (fator_id) ON DELETE CASCADE ON UPDATE CASCADE
)ENGINE=InnoDB CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
CREATE TABLE favorito (
  ...
  CONSTRAINT favorito_dept FOREIGN KEY (favorito_dept) REFERENCES depts (dept_id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE gut_fatores (
  ...
  CONSTRAINT gut_fatores_fk1 FOREIGN KEY (pg_fator_critico_id) REFERENCES fator (fator_id) ON DELETE CASCADE ON UPDATE CASCADE
)ENGINE=InnoDB CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
CREATE TABLE gut_objetivos (
  ...
  CONSTRAINT gut_objetivos_fk1 FOREIGN KEY (pg_objetivo_estrategico_id) REFERENCES objetivo (objetivo_id) ON DELETE CASCADE ON UPDATE CASCADE
)ENGINE=InnoDB CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
CREATE TABLE instrumento (
  ...
  instrumento_valor DECIMAL(20,5) UNSIGNED DEFAULT 0,
  instrumento_valor_contrapartida DECIMAL(20,5) UNSIGNED DEFAULT 0,
...
CREATE TABLE metas_log (
  ...
  pg_meta_log_horas DECIMAL(20,5) UNSIGNED DEFAULT 0,
  pg_meta_log_descricao TEXT,
  pg_meta_log_custo DECIMAL(20,5) UNSIGNED DEFAULT 0,
...
CREATE TABLE objetivo_composicao (
  objetivo_composicao_pai INTEGER(100) UNSIGNED NOT NULL,
  objetivo_composicao_filho INTEGER(100) UNSIGNED NOT NULL,
  KEY objetivo_composicao_pai (objetivo_composicao_pai),
  KEY objetivo_composicao_filho (objetivo_composicao_filho),
  CONSTRAINT objetivo_composicao_filho FOREIGN KEY (objetivo_composicao_filho) REFERENCES objetivo (objetivo_id) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT objetivo_composicao_pai FOREIGN KEY (objetivo_composicao_pai) REFERENCES objetivo (objetivo_id) ON DELETE CASCADE ON UPDATE CASCADE
)ENGINE=InnoDB CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
CREATE TABLE objetivo_log (
  objetivo_log_id INTEGER(100) UNSIGNED NOT NULL AUTO_INCREMENT,
  objetivo_log_objetivo INTEGER(100) UNSIGNED DEFAULT NULL,
  objetivo_log_criador INTEGER(100) UNSIGNED DEFAULT NULL,
  objetivo_log_horas DECIMAL(20,5) UNSIGNED DEFAULT 0,
  objetivo_log_descricao TEXT,
  objetivo_log_custo DECIMAL(20,5) UNSIGNED DEFAULT 0,
  objetivo_log_nd VARCHAR(11) DEFAULT NULL,
  objetivo_log_categoria_economica VARCHAR(1) DEFAULT NULL,
  objetivo_log_grupo_despesa VARCHAR(1) DEFAULT NULL,
  objetivo_log_modalidade_aplicacao VARCHAR(2) DEFAULT NULL,
  objetivo_log_metodo INTEGER(100) UNSIGNED DEFAULT NULL,
	objetivo_log_exercicio INTEGER(4) UNSIGNED DEFAULT NULL,
  objetivo_log_problema TINYINT(1) DEFAULT 0,
  objetivo_log_referencia INTEGER(11) DEFAULT NULL,
  objetivo_log_nome VARCHAR(200) DEFAULT NULL,
  objetivo_log_data DATETIME DEFAULT NULL,
  objetivo_log_url_relacionada VARCHAR(250) DEFAULT NULL,
  objetivo_log_acesso INTEGER(100) DEFAULT 0,
  PRIMARY KEY (objetivo_log_id),
  KEY objetivo_log_objetivo (objetivo_log_objetivo),
  KEY objetivo_log_criador (objetivo_log_criador),
  CONSTRAINT objetivo_log_objetivo FOREIGN KEY (objetivo_log_objetivo) REFERENCES objetivo (objetivo_id) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT objetivo_log_criador FOREIGN KEY (objetivo_log_criador) REFERENCES usuarios (usuario_id) ON DELETE SET NULL ON UPDATE CASCADE
)ENGINE=InnoDB CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
CREATE TABLE plano_acao_item_custos (
  ...
  plano_acao_item_custos_moeda INTEGER(100) UNSIGNED DEFAULT 1, 
	plano_acao_item_custos_cotacao DECIMAL(6,5) UNSIGNED DEFAULT 1.00000,
...
CREATE TABLE plano_acao_item_gastos (
  ...
  plano_acao_item_gastos_bdi  DECIMAL(20,5) UNSIGNED DEFAULT 0,
	...
	plano_acao_item_gastos_cotacao DECIMAL(6,5) UNSIGNED DEFAULT 1.00000, 
...
CREATE TABLE plano_acao_log (
  ...
  plano_acao_log_horas DECIMAL(20,5) UNSIGNED DEFAULT 0,
  plano_acao_log_descricao TEXT,
  plano_acao_log_custo DECIMAL(20,5) UNSIGNED DEFAULT 0,
  ...
  plano_acao_log_reg_mudanca_percentagem DECIMAL(20,5) UNSIGNED DEFAULT NULL,
...
CREATE TABLE pratica_indicador_log (
  ...
  pratica_indicador_log_horas DECIMAL(20,5) UNSIGNED DEFAULT 0,
  pratica_indicador_log_descricao TEXT,
  pratica_indicador_log_custo DECIMAL(20,5) UNSIGNED DEFAULT 0,
...
CREATE TABLE pratica_log (
  ...
  pratica_log_horas DECIMAL(20,5) UNSIGNED DEFAULT 0,
  pratica_log_descricao TEXT,
  pratica_log_custo DECIMAL(20,5) UNSIGNED DEFAULT 0,
