...
echo '<tr><td align="right" width="230">'.dica('Pergunta', 'Escreva uma pergunta para a eventualidade de esquecer o login/senha de acesso ao sistema.').'Pergunta:'.dicaF().'</td><td colspan="2"><input type="text" class="texto" name="usuario_frase" value="'.(isset($usuario['usuario_frase']) ? $usuario['usuario_frase']:'').'" maxlength="255" style="width:260px;" /></td></tr>';
echo '<tr><td align="right" width="230">'.dica('Resposta', 'Escreva uma resposta a pergunta para a eventualidade de esquecer o login/senha de acesso ao sistema.').'Resposta:'.dicaF().'</td><td colspan="2"><input type="text" class="texto" name="usuario_resposta" value="'.(isset($usuario['usuario_resposta']) ? $usuario['usuario_resposta']:'').'" maxlength="255" style="width:260px;" /></td></tr>';
