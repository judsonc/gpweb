...
class CAplic {
  ...
  function resetJS(){
    ...
    echo '<script type="text/javascript" src="'.get_base_url().'/js/gpweb.js"></script>';
    ...
    */
    function carregarCKEditorJS($altura='50'){
        ...
        if ($this->profissional) {
            ...
            echo '<script type="text/javascript" src="'.get_base_url().'/lib/ckeditor/ckeditor.js"></script>';
            }
        }
    ...
    function carregarExtJS($carregarGantt = false, $carregarChart = false){
        ...
        if($carregarGantt){
            echo '<link href="'.get_base_url().'/lib/extgantt/resources/css/sch-gantt-all.css" rel="stylesheet" type="text/css" />';
            echo '<script src="'.get_base_url().'/lib/extgantt/gnt-all.js?_dc=1.0.3" type="text/javascript" charset="UTF-8"></script>';
            }
