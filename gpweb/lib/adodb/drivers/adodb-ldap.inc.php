...
*/
    ...
    function ServerInfo()
    {
        ...
        */
        ...
        /*
        A limit on the number of segundos to spend on a search. 
        LDAP_NO_LIMIT (0) means no limit.
        Default: LDAP_NO_LIMIT
        */
...
class ADORecordSet_ldap extends ADORecordSet{	
	...
	var $databaseType = "ldap";
	var $canSeek = false;
	var $_entryID; /* keeps track of the entry recurso identifier */
	
	function ADORecordSet_ldap($queryID,$modo=false) 
	{
		if ($modo === false) { 
